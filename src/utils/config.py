...
class Config:
    ...
    NEWS_API_CONFIG = {
        'query': 'business OR economy OR finance OR market OR stock OR investment OR startup OR technology',        'from_date': '2026-07-17',  # Will be dynamically set
        'to_date': '2026-08-19',    # Will be dynamically set
        'language': 'en',
        'sort_by': 'popularity',
        'page_size': 100,
        'max_retries': 3,
    ...
    @classmethod
    def update_dates(cls, days_back: int = 5) -> None:
